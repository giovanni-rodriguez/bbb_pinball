...
describe("Near me button", () => {
    ...
    test("it updates latitude and longitude inputs with users current location", async () => {
    ...
    test("it calls the handleGeoLocationError function when there is an error getting the current location", () => {
